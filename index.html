...
<ul> 
<li class="i-world"><a href="vote.php">Vote4Cash</a></li> 
...
<div class="buttons"> 
<a href="client/" class="button" id="button-left"><br style="line-height: 200%">
Play BrainScape<br>(New Member)</a> 
<a href="client/index.php=option1.php" class="button" id="button-right"><br style="line-height: 200%"> 
Play BrainScape<br> 
(Old Member)</a> 
</div> 
...
<dt style="text-align: center;"><img src="img/title2/server-features.png" alt="Recent Updates"></dt> 
<dt>&nbsp;</dt> 
<dt><img src="img/title2/pmod_icon.gif" alt="News"> By: Gmk 177 - Title: Welcome to BrainScape! <img src="img/title2/pmod_icon.gif" alt="News"></dt> 
<dd> 
<table width="100%"><tr> 
<td style="text-align: justify; vertical-align: top;">Hello & Welcome to <b>BrainScape</b>. Were glad you've joined our RSPS, we are recently back up from the server named <b>ExodusX, BoxRune, BrutalX</b>. There will be many changes on the server itself and the website itself so be looking forward for that.</td> 
...
<td style="padding-left: 1em; text-align: right; vertical-align: top;">
<br>
<center><h2><a href="#">Click Here</a> for updates!</h2></center>
</td></tr></table>
</dd> </dl>
</div> 
</div> 
...
<div class="tandc"> 
  <p>Copyright &copy; 2012 BrainScape - All Rights Reserve
    </p> 
  </div> 
</div> 
